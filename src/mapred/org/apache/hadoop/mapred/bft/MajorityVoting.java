package org.apache.hadoop.mapred.bft;
...
public class MajorityVoting implements VotingSystem {
	 ...
	 */
	  ...
	  */
	   ...
	   * to help to count the map digests 
	   * @param id
	   * @param task
	   */
	  ...
	  public JSONObject jsonfy(String jobid, boolean isMap) {
		  return JSONUtils.jsonfy(jobid, mapHashList, isMap);
	  }
	  
	  public JSONObject jsonfy(String jobid, Map<String, List<String>> hashList, boolean isMap) {
		  return JSONUtils.jsonfy(jobid, hashList, isMap);
	  }
	  
	  public String jsonfyFailedTasks(String jobid, String taskid, boolean isMap) {
		  return JSONUtils.jsonfyFailedTasks(jobid, taskid, isMap);
	}
}
